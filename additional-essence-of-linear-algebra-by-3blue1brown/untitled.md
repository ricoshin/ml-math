...
* $$\underbrace{\begin{bmatrix} 1 & 2 & 1  \\ 2 & 4 & 2\end{bmatrix}}_{(1)} \ \ \underbrace{\begin{bmatrix} -2 \\ 1 \\ 3 \end{bmatrix}}_{(2)} = \underbrace{\begin{bmatrix} 3 \\ 6 \end{bmatrix} }_{(3)}$$
* 이 식은 **구좌표계**$$\left( \begin{bmatrix} 1 \\ 0 \\0 \end{bmatrix},  \begin{bmatrix} 0 \\ 1 \\0 \end{bmatrix}, \begin{bmatrix} 0 \\ 0 \\ 1 \end{bmatrix} \right)$$에서 **신좌표계** $$\left( \begin{bmatrix} 1 \\ 2 \end{bmatrix}, \begin{bmatrix} 2 \\ 4 \end{bmatrix}, \begin{bmatrix} 1 \\ 2 \end{bmatrix}\right)$$ 로의 선형변환을 의미한다. 
...
* $$\text{old bases}\left( \begin{bmatrix} 1 \\ 0 \\0 \end{bmatrix},  \begin{bmatrix} 0 \\ 1 \\0 \end{bmatrix}, \begin{bmatrix} 0 \\ 0 \\ 1 \end{bmatrix} \right) \xRightarrow [Transformation] {(1) \ (\text{old}\rightarrow \text{new}) \ \text{coord. system}} \ \text{new bases}\left( \begin{bmatrix} 1 \\ 2 \end{bmatrix}, \begin{bmatrix} 2 \\ 4 \end{bmatrix}, \begin{bmatrix} 1 \\ 2 \end{bmatrix}\right)$$
* 이 과정에서 구좌표계를 기준으로한 우리의 misconception이 새로운 좌표계의 좌표로써 변환된다.  
* $$(2) \ \begin{bmatrix} -2 \\ 1 \\ 3 \end{bmatrix}\text{w.r.t. old system}  \xRightarrow[Translation]{(1) \ (\text{old} \rightarrow \ \text{new}) \ \text{coord. system}}  (2) \  \begin{bmatrix}  -2 \\ 1 \\ 3  \end{bmatrix} \text{w.r.t. new system}  $$ 
...
* $$(2) \ \text{new coord.}  \begin{bmatrix}  -2 \\ 1 \\ 3 \end{bmatrix} \text{} \xRightarrow[Translation]{(1) \ (\text{new} \rightarrow \ \text{old}) \ \text{coord. system}}  (3) \ \text{old coord.} \begin{bmatrix} 3 \\ 6 \end{bmatrix}$$ 
